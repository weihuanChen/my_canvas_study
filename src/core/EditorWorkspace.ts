...
class EditorWorkspace {
  ...
  // height: number;
  dragMode: boolean;
  constructor(canvas: fabric.Canvas, option: EditorWorkspaceOption, workspace: fabric.Rect | null = null) {
    this.canvas = canvas;
  ...
  _initBackground() {
    ...
    //this.canvas.backgroundImage = 'src/assets/filters/kotei_9628.png';
