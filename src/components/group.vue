  ...
  <div v-if="false">
    <div class="attr-item box" v-if="isMultiple || isGroup">
      ...
      <Button v-if="isMultiple" :disabled="!isMultiple" @click="group" type="text">
        <svg t="1650848913991" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="17131" width="14" height="14">
          <path
      ...
      <Button v-if="isGroup" :disabled="!isGroup" @click="unGroup" type="text">
        <svg t="1650848938557" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="17281" width="14" height="14">
          <path
...
import { computed, onMounted, watch, watchEffect, defineProps } from 'vue'
const { canvas, mixinState } = useSelect();
import useSelectStore from '@/store/selectAttributes.js'
const { selectItem } = useSelectStore()
// 单选且等于组元素
...
//是否为路径,为路径时才能使用群组工具
let isPath = computed(() => selectItem === 9)
// 拆分组
const unGroup = () => {
